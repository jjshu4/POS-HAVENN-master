...
public class HAVEN_POS extends javax.swing.JFrame {
    ...
    private void billActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_billActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Select your Order.");
        }
            else {
                ...
                Connection con=(Connection) DriverManager.getConnection("jdbc.mysql//localhost:3306/brewhaven_db","root","");
                for(int i=0;i<tblModel.getRowCount();i++) {
                    ITEM = tblModel.getValueAt (i, 0).toString();
                    QTY = tblModel.getValueAt (i, 0).toString();
                    PRICE = tblModel.getValueAt (i, 0).toString();
                    
                    String query = "insert into beverages(ITEM,QTY,PRICE) values (?, ?, ?)";
                    PreparedStatement prepstmt = con.prepareStatement(query);
                    prepstmt.setString(1, ITEM);
                    prepstmt.setString(2, QTY);
